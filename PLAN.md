...
Chaque critère doit être vérifiable par un agent `/verifier` ou en CI. Pas de "ça a l'air OK".
...
- `ARCHITECTURE.md` existe et est à jour (structure dossiers, flux de données, décisions)
